...
public class TernaryPuzzle extends Fifteen implements Verify,Outmod{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titleLevel.setText(getResources().getText(R.string.level_seven));
        ...
        mChronometer.start();
        showMessage(getResources().getString(R.string.name_level_seven));
    }
    ...
    public boolean checkOverGame() {
        ...
        for (int i = 0; i < 4; i++) {
            for (int j = 0; j < 4; j++) {
                ...
                if (button == buttons[0][2] && getTitleButton(button).equals("10")) { count++; }
                if (button == buttons[0][3] && getTitleButton(button).equals("11")) { count++; }
                if (button == buttons[1][0] && getTitleButton(button).equals("12")) { count++; }
                if (button == buttons[1][1] && getTitleButton(button).equals("20")) { count++; }
                if (button == buttons[1][2] && getTitleButton(button).equals("21")) { count++; }
                if (button == buttons[1][3] && getTitleButton(button).equals("22")) { count++; }
                if (button == buttons[2][0] && getTitleButton(button).equals("100")) { count++; }
                if (button == buttons[2][1] && getTitleButton(button).equals("101")){ count++; }
                if (button == buttons[2][2] && getTitleButton(button).equals("102")){ count++; }
                if (button == buttons[2][3] && getTitleButton(button).equals("110")){ count++; }
                if (button == buttons[3][0] && getTitleButton(button).equals("111")){ count++; }
                if (button == buttons[3][1] && getTitleButton(button).equals("112")){ count++; }
                if (button == buttons[3][2] && getTitleButton(button).equals("120")){ count++; }
            }
        }
    ...
    public void nextLevel() {
        Intent intent_cont = new Intent(getApplicationContext(), FivefoldPuzzle.class)
