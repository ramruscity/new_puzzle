...
public class ClassicPuzzle extends Fifteen implements Verify,Outmod {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titleLevel.setText(getResources().getText(R.string.level_one));
        ...
        mChronometer.start();
        showMessage(getResources().getString(R.string.name_level_one));
    }
    ...
    public void nextLevel() {
        Intent intent_cont = new Intent(getApplicationContext(), VerticalPuzzle.class)
