...
public class VerticalPuzzle extends Fifteen implements Verify, Outmod {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        currentLevel = 2;
        passedLevel = 3;
        titleLevel.setText(getResources().getText(R.string.level_two));
        ...
        mChronometer.start();
        showMessage(getResources().getString(R.string.name_level_two));
    }
    ...
    public boolean checkOverGame() {
        ...
        for (int i = 0; i < 4; i++) {
            for (int j = 0; j < 4; j++) {
                ...
                if (button == buttons[0][1] && getTitleButton(button).equals("5")) { count++; }
                if (button == buttons[0][2] && getTitleButton(button).equals("9")) { count++; }
                if (button == buttons[0][3] && getTitleButton(button).equals("13")) { count++; }
                if (button == buttons[1][0] && getTitleButton(button).equals("2")) { count++; }
                if (button == buttons[1][1] && getTitleButton(button).equals("6")) { count++; }
                if (button == buttons[1][2] && getTitleButton(button).equals("10")) { count++; }
                if (button == buttons[1][3] && getTitleButton(button).equals("14")) { count++; }
                if (button == buttons[2][0] && getTitleButton(button).equals("3")) { count++; }
                if (button == buttons[2][1] && getTitleButton(button).equals("7")){ count++; }
                if (button == buttons[2][2] && getTitleButton(button).equals("11")){ count++; }
                if (button == buttons[2][3] && getTitleButton(button).equals("15")){ count++; }
                if (button == buttons[3][0] && getTitleButton(button).equals("4")){ count++; }
                if (button == buttons[3][1] && getTitleButton(button).equals("8")){ count++; }
                if (button == buttons[3][2] && getTitleButton(button).equals("12")){ count++; }
            }
        }
    ...
    public void nextLevel() {
        Intent intent_cont = new Intent(getApplicationContext(), RomePuzzle.class)
