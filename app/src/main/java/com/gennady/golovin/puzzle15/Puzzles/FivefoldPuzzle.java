...
public class FivefoldPuzzle extends Fifteen implements Verify,Outmod {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titleLevel.setText(getResources().getText(R.string.level_eight));
        ...
        mChronometer.start();
        showMessage(getResources().getString(R.string.name_level_eight));
    }
    ...
    public boolean checkOverGame() {
        ...
        for (int i = 0; i < 4; i++) {
            for (int j = 0; j < 4; j++) {
                ...
                if (button == buttons[1][0] && getTitleButton(button).equals("10")) { count++; }
                if (button == buttons[1][1] && getTitleButton(button).equals("11")) { count++; }
                if (button == buttons[1][2] && getTitleButton(button).equals("12")) { count++; }
                if (button == buttons[1][3] && getTitleButton(button).equals("13")) { count++; }
                if (button == buttons[2][0] && getTitleButton(button).equals("14")) { count++; }
                if (button == buttons[2][1] && getTitleButton(button).equals("20")){ count++; }
                if (button == buttons[2][2] && getTitleButton(button).equals("21")){ count++; }
                if (button == buttons[2][3] && getTitleButton(button).equals("22")){ count++; }
                if (button == buttons[3][0] && getTitleButton(button).equals("23")){ count++; }
                if (button == buttons[3][1] && getTitleButton(button).equals("24")){ count++; }
                if (button == buttons[3][2] && getTitleButton(button).equals("30")){ count++; }
            }
        }
    ...
    public void nextLevel() {
        Intent intent_cont = new Intent(getApplicationContext(), OctalPuzzle.class)
